...
@Service
public class AdministratorBlackListCreateService implements AbstractCreateService<Administrator, BlackList>{
	...
	@Override
	public BlackList instantiate(final Request<BlackList> request) {
		assert request != null;
		
		final BlackList result = new BlackList();
		result.setWord("Example");
		return result;
	}
	...
	@Override
	public void create(final Request<BlackList> request, final BlackList entity) {
		assert request != null;
		assert entity != null;
