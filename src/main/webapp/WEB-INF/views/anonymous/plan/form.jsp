...
<acme:form readonly="true">
	...
	<h5><spring:message code="anonymous.plan.form.label.tasks"/></h5>
	<table id="list" class="table table-striped table-condensed table-hover nowrap w-100">
	    <thead>
	    	<tr>
			    <th>
			    	<spring:message code="anonymous.plan.form.label.title"/>
			    </th>
			     <th>
			    	<spring:message code="anonymous.plan.form.label.executionStart"/>
			    </th>
			     <th>
			    	<spring:message code="anonymous.plan.form.label.executionEnd"/>
			    </th>
	    	</tr>
	    </thead>
	    <tbody>
